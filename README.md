...
- **Eight learning modules**, each with clear prose, key facts, and inline citations to primary sources:
  ...
  8. Myths & Misconceptions — the common false claims about measles and the vaccine, what the evidence really shows, and how to spot the next myth yourself
- **Quizzes** for every module — 34 questions in all — with instant feedback and an explanation for each answer.
- **Interactive timeline** of 22 key events spanning from measles' emergence (~528 BCE) through the 2025 U.S. resurgence — the largest since 1992.
